const { replacePendingOrder ,replacePendingOrderShrirampur} = require('../services/sftpService');
...
module.exports = { replacependingordercontroller ,replacependingordercontrollerShrirampur};
